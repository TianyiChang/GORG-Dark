...
metag_full_list = pd.read_table('../../metadata/local_maria_cariaco_metag_list.txt')
...
# rule trimmomatic:
#     input:
#         "../../metag/from_maria_cariaco/{metag}_1.fastq.gz",
#         "../../metag/from_maria_cariaco/{metag}_2.fastq.gz"
#     output:
...
rule read_merge:
    input:
        f="../../metag/from_maria_cariaco/{metag}_1_paired.fq.gz",
        r="../../metag/from_maria_cariaco/{metag}_2_paired.fq.gz"
    output:
